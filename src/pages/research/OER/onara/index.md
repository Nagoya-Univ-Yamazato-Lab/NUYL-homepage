...
<ruby>平賀源内<rt>ひらがげんない</rt></ruby>は、なんと、<ruby>霧降<rt>きりふり</rt></ruby><ruby>花咲男<rt>はなさきおとこ</rt></ruby>について「<ruby>放屁論<rt>ほうひろん</rt></ruby>」と「<ruby>放屁論後編<rt>ほうひろんこうへん</rt></ruby>」いう<ruby>本<rt>ほん</rt></ruby>を<ruby>書<rt>か</rt></ruby>くぐらいですが、よっぽど<ruby>好<rt>す</rt></ruby>きだったのでしょうね。びっくりです。
...
そこで、源内先生は、「本日土用丑の日」と書いて店先に掲げることを店主に言いました。
土用丑の日に「う」のつくものを食べると「無病息災」になる、と広めたところ、うなぎが飛ぶように売れ、以後、土用の丑の日にうなぎを食べる習慣が広まりました。
...
正確に言うと、おならそのもの、というよりは当時、屁芸（おなら芸）で江戸を沸かせたいた放屁男、霧降花咲男について論じています。
...
音はあるが太鼓や鼓のように聞けるような音でも無い。においもするが香水のように使うわけにもいかない。
それどころか、人を臭がらせ、空よりでて空に消えてゆき、肥料にならなければ、まったく何の役にも立ちません。
...
たかがおなら、されどおならであります。
まったく役に立たないおならであっても、心をこめて修行をすればこんなに素晴らし芸になるのだから、もし、賢人がいて、このおならのようにいろいろと工夫をし、天下の人を救うことがあるならば、その功績はどんなに大きいことだろうかと考えます。
思慮をめぐらしながら修行をすれば、おならでさえも、このように役に立つものです。

わたしは、このおならの音をかりて、自暴自棄・未熟・無精のものたちの眠りをさましたいのです。

と言ってみたもののどうも理屈臭い話になりました。
...
結局のところ、エレキテルを使うことで人の体から火が出る道理も、おならが出るのと同じなのであります。エレキテルもヘレキテルと名前を替えれば良いのかも知れません。
...
さて、霧降花咲男のように、おならをすることで人を楽しませる芸人を放屁師（ほうひし）または屁男（へっぴりおとこ）と言います。
猿猴庵合纂四集 19ページに屁男の説明がありますので、クリックしてご覧ください。

- [財団法人 東洋文庫 所蔵　画像データベース（東洋学多言語資料のマルチメディア電子図書館情報システム）](https://www.toyo-bunko.org/gazou/index_img.php?tg=H3&c1=あ)<br />
[猿猴庵合纂四集 19ページ　屁男](http://124.33.215.236/gazou/2010/gazo2010_read.php?TGName=3-I-b-12_04&iTargetPage=19&size=1000)
...
- 市川こいくち
  - 吉本興業所属の放屁師です。自由自在におならをこくことができます。日本より海外で有名かも、です。ゴットタレントの動画は抱腹絶倒です。

- ミスターメタン（Mr Methane）
  - イギリスの放屁師です。放屁師のことを英語では Flatulist と言いますが、なんと、[ギネスの世界記録保持者](https://www.guinnessworldrecords.jp/world-records/651584-longest-career-as-a-flatulist)です。しかも「おなら芸」で、です。

この方々であれば、おなら通信はできますね。でも、こんな特技の無い人はどうすれば良いのでしょうか？練習してできるものでもありませんし・・・
